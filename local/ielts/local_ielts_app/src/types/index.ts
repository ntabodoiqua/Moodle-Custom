...
export type QuestionType =
  ...
  | "TRUE_FALSE"
  | "YES_NO"
  | "SHORT_ANSWER" // Gộp: GAP_FILL, SHORT_ANSWER, SUMMARY_COMPLETION
  | "MATCHING" // Gộp: MATCHING, MATCHING_HEADINGS, MATCHING_INFORMATION, MATCHING_FEATURES, MATCHING_SENTENCE_ENDINGS
  | "MAP_LABELING"
  | "TABLE_COMPLETION";
